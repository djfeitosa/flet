...
class Task(UserControl):
    ...
    def build(self):
        ...
        self.edit_name = TextField(
            expand=1
        )  # entrada de texto da edição da tarefa
...
class TodoApp(UserControl):
    ...
    def add_clicked(self, e):
        if self.new_task.value:
            task = Task(
                self.new_task.value, self.task_status_changed, self.task_delete
            )
...
def main(page: Page):
    ...
    # Instanciar a classe princiapal
    app = TodoApp()
